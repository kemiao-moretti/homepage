...
If you don't have a spare VPS, you can run it on [**claw.cloud**](https://404.li/claw) ($5 monthly free tier for GitHub accounts older than 180 days).
...
![Claw Configuration](https://static.miantiao.me/share/g4KUgP/claw.jpg)

## Configuring MCP Proxy

Mount your config at `/config/config.json`. (See the [official documentation](https://github.com/TBXark/mcp-proxy?tab=readme-ov-file#configuration) for options).
...
Taking [**ChatWise**](https://404.li/chatwise) connecting to the `fetch` server as an example: select the SSE transport and enter the proxy endpoint URL:

![Connecting fetch tool](https://static.miantiao.me/share/mI3zIh/fetch.jpg)
